            ...
            <div className="relative inline-block align-bottom bg-white rounded-lg text-left shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              ...
              <form>
                <div className="w-full h-10 px-4 flex flex-col mb-1 md:justify-between items-center md:flex-row">
                  ...
                  <div className=" bg-white border border-gray-300 rounded shadow-sm px-4 w-full md:w-1/2 focus:border-gray-500">
                    <input
                      type="email"
                      name="email"
                      id="email"
                      placeholder="Email"
                      autoComplete="email"
                      className="w-full pt-1 text-center font-medium text-xs border-none focus:border-none focus:outline-none focus:ring-1 focus:ring-red-700"
              ...
              <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button
                  ...
                  className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-800 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-700 sm:ml-3 sm:w-auto sm:text-sm"
                >
                  Valider
                </button>
                <button
