...
import ModalConfirmDeletePerso from "./ModalConfirmDeletePerso";
...
export default function DeletePerso({
  ...
  const handleClose = () => {
    ...
    setPersoDelete(!persoDelete);
  };

  return (
    <div>
      <ModalConfirmDeletePerso
      ...
      <Menu as="div" className="flex-shrink-0 relative inline-block text-left">
        <Menu.Button className="group relative w-8 h-8 bg-white rounded-full inline-flex items-center justify-center focus:outline-none focus:ring-1 focus:ring-offset-0 focus:ring-red-700">
