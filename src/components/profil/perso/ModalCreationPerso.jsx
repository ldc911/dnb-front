          ...
          >
            <div className="inline-block bg-white rounded-lg px-4 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all my-8 align-middle max-w-lg w-full p-6 max-w-5/6">
              ...
              <div className="mt-6 flex justify-end">
                <button
                  type="button"
                  className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 sm:mt-0 sm:w-auto sm:text-sm focus:border-none focus:ring-1 focus:ring-red-700"
