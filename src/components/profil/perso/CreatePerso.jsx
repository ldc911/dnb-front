    ...
    <form encType="multipart/form-data" onSubmit={handleSubmit}>
      <div className=" w-full h-full bg-white rounded-md py-6 px-2  shadow text-xs md:text-base flex flex-col items-center">
        <div className="w-full h-10 mb-1 px-4 flex flex-row justify-between items-center relative">
          <button
            type="button"
            className="py-1 px-1 cursor-pointer border-transparent border-2 border-slate-100 rounded-md text-grey hover:text-red-700 focus:outline-none focus:ring-1 focus:ring-red-700 max-w-20"
          >
            Avatar
            <input
              type="file"
        ...
        <div className="w-full h-10 mb-1 px-4 flex flex-row justify-between items-center">
          ...
          <div className=" bg-white border border-gray-300 rounded shadow-sm  pl-4 pr-4 py-1 w-1/2">
            <input
              type="text"
        ...
        <div className="w-full h-10 mb-1 px-4 flex flex-row justify-between items-center">
          ...
          <div className=" border border-gray-300 rounded shadow-sm  pl-4 pr-4 py-1 w-1/2 ">
            <input
              type="text"
              value={perso.classe}
              onChange={handleChangeClasse}
              placeholder="Classe / ss-classe"
              className="text-center w-full h-6 focus:border-none border-none text-sm focus:ring-1 focus:ring-red-700"
            />
          </div>
        </div>
        <div className="w-full h-full mb-1 px-4 flex flex-row justify-between items-start">
          ...
          <div className=" border border-gray-300 rounded shadow-sm px-1 py-1 w-1/2 ">
            <textarea
              ...
              id=""
              rows="5"
              className="w-full h-full border-slate-300 rounded text-center border-none scrollbar-hide focus:ring-1 focus:ring-red-700"
        ...
        <div className="w-full h-full mb-5 px-4 flex flex-row justify-between items-start">
          ...
          <div className=" border border-gray-300 rounded shadow-sm  px-1 py-1 w-1/2 ">
            <textarea
              ...
              id=""
              rows="5"
              className="w-full h-full border-slate-300 rounded text-center focus:ring-1 focus:ring-red-700 border-none scrollbar-hide"
